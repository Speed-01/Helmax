...
urlpatterns = [
    ...
    path('toggle-product-status/<int:product_id>/', views.toggle_product_status, name='toggle_product_status'),    path('toggle-variant/<int:variant_id>/', views.toggleVariant, name='toggleVariant'),
